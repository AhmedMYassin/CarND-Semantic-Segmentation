...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    conv_1x1_7 = tf.layers.conv2d(vgg_layer7_out, 
				                  ...
				                  kernel_regularizer= tf.contrib.layers.l2_regularizer(regularizer_l2), 
				                  name='conv1x1_7')
    
    upsample_1 = tf.layers.conv2d_transpose(conv_1x1_7, 
					                        num_classes, 
					                        4, 
                                            strides=(2,2), 
					                        padding='same', 
    ...
    upsample_2 = tf.layers.conv2d_transpose(skip_1, 
					                        num_classes, 
					                        4, 
					                        strides=(2,2), 
					                        padding='same', 
    ...
    skip_2 = tf.add(upsample_2, conv_1x1_3, name='skip_2')

    upsample_3 = tf.layers.conv2d_transpose(skip_2, 
					                        num_classes, 
					                        16, 
					                        strides=(8,8), 
					                        padding='same', 
...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
    ...
    for epoch in range(epochs):
        ...
        for batch_idx,(image, label) in enumerate(get_batches_fn(batch_size)):
